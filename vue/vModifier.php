			...
			<table class=" table table-striped">
				...
				<tr>
					...
					<form class="form-inline" method="POST" action="?page=modifier">
						...
						<td>
							<button type="submit" class="btn btn-default" name="envoyer" <?php echo "value ='".$_POST['envoyer']."'";?>>Modifier</button>
						</td>
					</form>
				</tr>
				<tr>
					<td align="right"><label for="Tag">Choisir des tags</label></td>
					<td></td>
					<td>
